...
define('LBMN_DEVELOPER_URL', 'http://lumbermandesigns.com/');
define('LBMN_SUPPORT_URL', 'http://themeforest.net/item/seo-wp-social-media-and-digital-marketing-agency/8012838/support/contact/');
...
// Footer
define('LBMN_FOOTER_DESIGN_TITLE_BASIC', 'Footer – Basic');
define('LBMN_FOOTER_DESIGN_TITLE_DEFAULT', 'Footer – Default');
define('LBMN_FOOTER_DESIGN_TITLE_DEFAULT_COMPATIBILITY', '4 columns footer');

// System Page Templates
define('LBMN_SYSTEMPAGE_404_DEFAULT', '404 Page Not Found');
define('LBMN_SYSTEMPAGE_SEARCHRESULTS_DEFAULT', 'Search Results Listing Template');
