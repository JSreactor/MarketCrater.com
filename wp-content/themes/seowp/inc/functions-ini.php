...
function lbmn_scripts() {
	...
	$customizerMobileMenu['mobile_menu'] = get_theme_mod( 'lbmn_advanced_off_canvas_mobile_menu', 1 );
	wp_localize_script( 'lbmn-custom-js', 'customizerOffCanvasMobileMenu', $customizerMobileMenu );
